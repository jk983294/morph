...
from rl.utils.TargetNet import TargetNet
from rl.utils.rl_utils import TBMeanTracker
...
if __name__ == "__main__":
    ...
    net = model.R4Net(input_shape=model.OBS_SHAPE, actions_n=game.GAME_COLS).to(device)
    ...
    with TBMeanTracker(writer, batch_size=10) as tb_tracker:
        while True:
            ...
            for _ in range(PLAY_EPISODES):
                # constantly plays against itself
