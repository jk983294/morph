...
class MCTS:
    ...
    def __init__(self, c_puct=1.0):
        ...
        self.visit_count: Dict[int, List[float]] = {}  # state_int -> [N(s, a)]
        self.value: Dict[int, List[float]] = {}  # state_int -> [W(s, a)]
        self.value_avg: Dict[int, List[float]] = {}  # state_int -> [Q(s, a)]
        self.probs: Dict[int, List[float]] = {}  # state_int -> [P(s,a)], prior probability of actions
    ...
    def find_leaf(self, state_int, player):
        ...
        while not self.is_leaf(cur_state):
            ...
            action_score = [value + self.c_puct * prob * total_sqrt / (1 + count)
