...
class DuelDQN(nn.Module):
    ...
    def forward(self, x):
        ...
        return value_ + (advantage_ - torch.mean(advantage_, dim=1, keepdim=True))
...
if __name__ == '__main__':
    ...
    model = DuelDQN(env.observation_space.shape[0], env.action_space.n, hidden_size)
    tgt_net = DuelDQN(env.observation_space.shape[0], env.action_space.n, hidden_size)
